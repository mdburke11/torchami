...
TamiGraph::TamiGraph(TamiBase::graph_type type, int seed) : rand_gen(seed), rand_dist(0,1.0), engine(12){
...
TamiGraph::TamiGraph(TamiBase::graph_type type, int dim, int seed) : rand_gen(seed), rand_dist(0,1.0), engine(12){
...
void TamiGraph::initialize(TamiBase::graph_type type, int dim){
    ...
    //TODO: is this needed? -MB current_state.initialize( graph_order(current_graph) , dim); 
}
...
void TamiGraph::initialize(TamiBase::graph_type type){
    ...
    //TODO: is this needed? -MB current_state.initialize( graph_order(current_graph) , 2); // this 2 hardcodes 2D. need a dimensionality parameter from somewhere.
...
void TamiGraph::construct_starter_force(graph_t &g, graph_t &f, graph_t &fp){
    ...
    // make the bubble
    add_edge(fpbubble_left,fpbubble_right,edge_info(TamiBase::Fermi,1,dn),fp);
    add_edge(fpbubble_right,fpbubble_left,edge_info(TamiBase::Fermi,1, dn),fp);
