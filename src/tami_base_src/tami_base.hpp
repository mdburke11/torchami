...
public:
  ...
  /// This is the list of internal and external frequencies values across and
  /// differnt values to be evalated simultaneously down, external fr. Typically
  ...
  /// Integrates a single Matsubara index. --  renamed from the original
  /// function name (TamiBase::integrate_step())
